...
intro:
  - excerpt: "Version 9.0.0, released October 2025 (EN, DE, FR, CZ, ZH), Version 8.2.1 (all other languages) released October 2024. Added Hungarian HU translatio, July 2026."
...
Version 9, now also offering a Chinese ZH translation. Thanx to Chris (Gentle) Y杨 and DannyGe. Hungarian translation (July 2026) by László Séra.
...
{% assign languages = "EN|CZ|DE|ES|IT|FR|HU|NL|PT|RU|UKR|ZH" | split: "|" %}
{% assign languages_full = "English|Čeština|Deutsch|Español|Italiano|Français|Magyar|Nederlands|Português|Русский|Українська|简体中文" | split: "|" %}
